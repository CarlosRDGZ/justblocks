...
function generateUsers(amount) {
  for (var i = 0; i < amount; i++) {
    var user = new User({
        ...
        email: `${falseNames[i].first}${i}@ucol.mx`
      });
